...
<div class="main-container">
    <div class="header">
        <div class="logo"><h1>🏡 Ramesh Homes <span>estate</span></h1></div>
        ...
        function renderBookings() {
            ...
            if (bookings.length === 0) bookingListEl.innerHTML = '<li>No bookings yet.</li>';
                ...
                bookings.sort((a,b)=>new Date(b.meetingTime)-new Date(a.meetingTime)).forEach(b => {
                    ...
                    bookingListEl.innerHTML += `<li><strong>${b.name}</strong><br>📞 ${b.phone}<br>🏠 ${proj.title}<br>⏱️ ${new Date(b.meetingTime).toLocaleString()}</li>`;
                });
            }
